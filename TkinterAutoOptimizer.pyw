...
class MainAppController(object):
	...
	def winfive(self):
		...
		subprocess.Popen('cd %programfiles(x86)%/google/chrome/application/ && chrome chrome//extensions/', shell=True)
		
	def winsix(self):
		#os.system('%CD%/ProgFiles/batteryinfoview/batteryinfoview.exe')
		subprocess.Popen('%CD%/ProgFiles/batteryinfoview/batteryinfoview.exe', shell=True)
