...
class AutOptimizer(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		PageTwoButton1 = tk.Button(self, width=20, height=5, text="Startup Porgams", command=lambda: subprocess.Popen('%CD%/ProgFiles/whatinstartup/whatinstartup.exe', shell=True))
